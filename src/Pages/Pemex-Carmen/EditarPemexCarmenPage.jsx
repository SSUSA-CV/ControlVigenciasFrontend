...
export const EditarPemexCarmenPage = () => {
  const {id} = useParams()
  ...
  useEffect(() => {
    axios.get(`https://controlvigenciasbackend-szwc.onrender.com/api/operadoresC_id/${id}`, { withCredentials: true })
    .then(response => {
  ...
  const handleSubmit = e => {
    ...
    axios.put(`https://controlvigenciasbackend-szwc.onrender.com/api/operadoresC/${data.id}`, {
      nombre,
      puesto,
      nss,
      tipo_sangre,
